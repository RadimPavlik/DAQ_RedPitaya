set display_name {AXI4-Stream fast DAQ}
...
set_property VENDOR {michal-kubicek} $core
set_property VENDOR_DISPLAY_NAME {Michal Kubicek} $core
set_property COMPANY_URL {http://www.urel.feec.vutbr.cz} $core
